...
def generate_launch_description():
    ...
    param_substitutions = {
        ...
        "save_map_folder_path": map_folder_path,
    }
    ...
    load_composable_nodes = LoadComposableNodes(
        ...
        composable_node_descriptions=[
            ComposableNode(
                ...
                parameters=[configured_params],
                remappings=[
                    ("visual_slam/image_0", "left_d435i/infra1/image"),
                    ("visual_slam/camera_info_0", "left_d435i/infra1/camera_info"),
                    ("visual_slam/image_1", "left_d435i/infra2/image"),
                    ("visual_slam/camera_info_1", "left_d435i/infra2/camera_info"),
                    ("visual_slam/imu", "left_d435i/imu"),
                ],
            ),
        ],
    )
